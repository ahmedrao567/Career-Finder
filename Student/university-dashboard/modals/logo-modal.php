    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full modal-content">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h3 class="text-xl font-semibold text-gray-900">Upload University Logo</h3>
        ...
        <form action="upload-logo.php" method="POST" enctype="multipart/form-data" class="p-6">
            <div class="mb-4">
                ...
                <div class="flex items-center justify-center w-full">
                    <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-purple-500 transition">
                        ...
                        <input id="logoInput" type="file" name="logo" class="hidden" accept="image/*" required>
                    </label>
                </div>
            </div>
            ...
            <div id="logoPreview" class="mb-4 hidden">
                ...
                <div class="flex justify-center">
                    <img id="logoPreviewImg" class="w-32 h-32 object-cover rounded-full border-4 border-white shadow-lg">
                </div>
            </div>
